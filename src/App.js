    ...
    return (
      <Router history={customHistory}>
        <div className="App">
          ...
          <PrivateRoute exact path="/home/:showId" movies={this.state.movies} deleteMovieFromMyStuff={this.deleteMovieFromMyStuff} addMovieToMyStuffState={this.addMovieToMyStuffState} component={MovieShow} />
          ...
          <PrivateRoute exact path="/tvshows/:showId" deleteMovieFromMyStuff={this.deleteMovieFromMyStuff} addMovieToMyStuffState={this.addMovieToMyStuffState} movies={this.state.movies} addToMyStuff={this.addToMyStuff} component={MovieShow}/>
          ...
          <PrivateRoute exact path="/movies/:showId" deleteMovieFromMyStuff={this.deleteMovieFromMyStuff} addMovieToMyStuffState={this.addMovieToMyStuffState} movies={this.state.movies} addToMyStuff={this.addToMyStuff} deleteFromMyStuff={this.deleteMovieFromMyStuff} component={MovieShow}/>
          ...
          <PrivateRoute exact path="/mystuff/:showId" deleteMovieFromMyStuff={this.deleteMovieFromMyStuff} addMovieToMyStuffState={this.addMovieToMyStuffState} movies={this.state.movies} addToMyStuff={this.addToMyStuff} component={MovieShow}/>
        </div>
      </Router>
...
// fetch('http://localhost:3000/api/v1/users', {
    ...
    // this.state.ids.filter(hash => hash.movie_id === id)[0].id